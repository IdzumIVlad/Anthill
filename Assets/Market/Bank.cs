...
public class Bank : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        playerAttack.attackPoint = PlayerPrefs.GetInt("playerAttack.attackPoint");
        healthPlayer.fullHealth = PlayerPrefs.GetFloat("expirience.lvl");

        enemyHealth.expAward = PlayerPrefs.GetInt("enemyHealth.expAward");
        enemyHealth.fullHealth = PlayerPrefs.GetFloat("enemyHealth.fullHealth");
    ...
    private void SaveData()
    {
        ...
        PlayerPrefs.SetFloat("expirience.lvl", healthPlayer.fullHealth);
